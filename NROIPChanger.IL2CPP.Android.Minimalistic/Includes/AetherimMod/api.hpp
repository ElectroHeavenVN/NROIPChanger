...
#  define GetHandle( module ) GetModuleHandleA( module )
#elif defined(_WIN32)
#  include <Windows.h>
...
namespace Il2cpp
{
    ...
    DEF_API(object_create, void*, (void* klass));
    ...
    DEF_API(create_string_utf8, Il2CppString*, (const char* text));
    DEF_API(create_string_utf8_with_length, Il2CppString*, (const char* text, uint32_t length));
    DEF_API(create_string_utf16, Il2CppString*, (const Il2CppChar* text, uint32_t len));
    ...
    inline void initialize()
    {
        ...
        const auto GameAssemblyHandle = GetHandle(targetLibName);
        ...
        DEF_ADDR(create_string_utf8, "il2cpp_string_new", GameAssemblyHandle);
        DEF_ADDR(create_string_utf8_with_length, "il2cpp_string_new_len", GameAssemblyHandle);
        DEF_ADDR(create_string_utf16, "il2cpp_string_new_utf16", GameAssemblyHandle);
