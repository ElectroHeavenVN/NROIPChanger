...
public class Menu {
    ...
    //region Variable
    public static final String TAG = "NROIPChanger"; //Tag for logcat
    ...
    public Menu(Context context) {
        ...
        hideBtn.setText(Strings.hideOrKill());
        ...
        hideBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                mExpanded.setVisibility(View.GONE);
                Toast.makeText(view.getContext(), Strings.iconHidden(), Toast.LENGTH_LONG).show();
            }
        });
        hideBtn.setOnLongClickListener(new View.OnLongClickListener() {
            public boolean onLongClick(View view) {
                Toast.makeText(view.getContext(), Strings.menuKilled(), Toast.LENGTH_LONG).show();
        ...
        closeBtn.setText(Strings.minimize());
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (Preferences.loadPref && !IsGameLibLoaded() && !stopChecking) {
                    if (!viewLoaded) {
                        Category(mods, Strings.gameLibNotLoaded());
                        Button(mods, -100, Strings.forceLoadMenu());
                        viewLoaded = true;
                    }
    ...
    private void InputNum(LinearLayout linLayout, final int featNum, final String featureID, final int maxValue) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (maxValue != 0)
                    editText.setHint(Strings.maxValue() + ": " + maxValue);
                ...
                alertName.setTitle(Strings.inputNumber());
                ...
                alertName.setNegativeButton(Strings.cancel(), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
    ...
    private void InputText(LinearLayout linLayout, final int featNum, final String featureID) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertName.setTitle(Strings.inputText());
                alertName.setView(editText);
                LinearLayout layoutName = new LinearLayout(getContext);
                layoutName.setOrientation(LinearLayout.VERTICAL);
                layoutName.addView(editText); // displays the user input bar
