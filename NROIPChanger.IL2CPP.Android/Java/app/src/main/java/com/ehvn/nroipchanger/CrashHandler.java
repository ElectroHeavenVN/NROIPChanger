...
//                }
                ...
                String dirName = "/storage/emulated/0/Android/Data/" + app.getPackageName() + "/Files/Crashes";
                ...
                Toast.makeText(app, Strings.gameCrashed(), Toast.LENGTH_LONG).show();
                Toast.makeText(app, Strings.logSavedTo() + ": " + String.valueOf(crashFile).replace("/storage/emulated/0/", ""), Toast.LENGTH_LONG).show();
